...
export default function FeaturesSection() {
  return (
    <section id="features" className="bg-[#0a0a0a] py-12 px-6 relative overflow-hidden">
      {/* Photo background — Cadillac Escalade interior. Falls back to the
          solid #0a0a0a on the section if the image fails to load. */}
      <div
        className="absolute inset-0"
        style={{
          backgroundImage: 'url(/slique_interior.png)',
          backgroundSize: 'cover',
          // Anchor the bottom of the photo to the bottom of the section so
          // the steering-wheel Cadillac crest sits in the upper area, between
          // the section top and the reviews row. Width / zoom are unchanged.
      ...
      {/* Dark scrim so the heading and card text stay readable over the photo. */}
