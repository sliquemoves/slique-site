  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-1">
        <h3 className="font-bubbly text-xl text-white font-light tracking-wide text-center mb-5">{rental.name}</h3>
                ...
                >
                  ...
                  <div className="space-y-4 text-center px-6">
                    <div>
                      ...
                      <h3 className="font-bubbly text-3xl md:text-3xl text-white font-light tracking-wide">{vehicle.name}</h3>
                    </div>
